...
```docker run --name pulumiNodeServerPicToTextInfra -d -it --mount type=bind,source={OS絶対ディレクトリ},target=/pulumi/projects/InfraPicToTxt pulumi/pulumi-nodejs:3.124.0 /bin/bash```
